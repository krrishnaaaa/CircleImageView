...
public class RoundedCornerImageView extends ImageView {
    ...
    public RoundedCornerImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTopLeftRadius = a.getDimensionPixelSize(R.styleable.CircleImageView_civ_top_left_radius, DEFAULT_RADIUS);
        mTopRightRadius = a.getDimensionPixelSize(R.styleable.CircleImageView_civ_top_right_radius, DEFAULT_RADIUS);
        mBottomLeftRadius = a.getDimensionPixelSize(R.styleable.CircleImageView_civ_bottom_left_radius, DEFAULT_RADIUS);
        mBottomRightRadius = a.getDimensionPixelSize(R.styleable.CircleImageView_civ_bottom_right_radius, DEFAULT_RADIUS);
        mIsCircle = a.getBoolean(R.styleable.CircleImageView_civ_circle, false);
